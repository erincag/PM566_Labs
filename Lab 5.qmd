...
```{r}
stat[, c("temp", "wind.sp", "atm.press")]
med.temp <- median(stat$temp, na.rm = TRUE)
med.wind.sp <- median(stat$wind.sp, na.rm = TRUE)
med.atm.press <- median(stat$atm.press, na.rm = TRUE)
```
